...
[Magento 2 Short Unique Category and Product URLs](https://www.ulmod.com/magento-2-catalog-urls.html) is a Magento 2 extension that allows you to use the longest, shortest possible product URLs and categories URLs in your Magento 2 site. Avoid duplicate content on the product with multiple URLs by permanently redirecting all URLs available for the product to the main canonical tag URL. You can exclude some category's path in the product URLs.

Also, you can use a category short URL by removing the parent categories' path to the category URL.

<a href="https://www.ulmod.com/magento-2-catalog-urls.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Ability to use longest, shortest, default product URLs or product URLs without categories path
* Ability to 301 auto-redirect all URLs available for a product to the main canonical tag URL of the prduct. Avoid duplicate content issues.
* Ability to remove specific categories path to product URLs
* Ability to short categories URLs by removing parent categories paths to category URLs
* Easy to configure and use. Support multiple-stores

<img src="https://www.ulmod.com//media/ulmod_products/catalogurl/seo-product-urls.png">
<img src="https://www.ulmod.com//media/ulmod_products/catalogurl/redirect-url.png">
<img src="https://www.ulmod.com//media/ulmod_products/catalogurl/exclude-category-path.png">
<img src="https://www.ulmod.com//media/ulmod_products/catalogurl/short-category-url.png">
